...
class DataLoaderValSubSet(Dataset):
    def __init__(self, rgb_dir, img_options=None, rgb_dir2=None):
        super(DataLoaderValSubSet, self).__init__()

        self.inp_filenames = self._get_list_(rgb_dir, 'blur')
        self.tar_filenames = self._get_list_(rgb_dir, 'sharp')
...
class DataLoaderTrainSubSet(Dataset):
    def __init__(self, rgb_dir, img_options=None):
        super(DataLoaderTrainSubSet, self).__init__()
